...
class KafkaHandler:
    ...
    def send_message(self, message: DocumentWrapper):
...
class FileProcessor:
    ...
    def convert_local_pdf_to_markdown(self, pdf_path, output_path=None):
        """
    ...
    def process_file(self, file_path: Path) -> bool:
        ...
        try:
            ...
            markdown_content = self.convert_local_pdf_to_markdown(file_path)
            
            # Create Pydantic model with a unique ID
            file_content = DocumentWrapper(
                ...
                metadata={
                    ...
                    "created_timestamp": datetime.fromtimestamp(file_path.stat().st_ctime),
